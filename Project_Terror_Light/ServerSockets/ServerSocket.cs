...
namespace Project_Terror_Light.ServerSockets
{
    public class ServerSocket
    {
        ...
        private void ConnectCallback(IAsyncResult ar)
        {
            try
            {
                ...
                Connection.ReceiveBufferSize = 8192;
                Connection.SendBufferSize = 8192;// اشمعنا ؟ 8 ده ا لكلى ك تما م ظبط ا لشيل بقي استني
        ...
        public void Accept()
        {
            ...
            try
            {
                ...
                if (Alive && Connection.Poll(0, SelectMode.SelectRead) && Connection.ProtocolType == ProtocolType.Tcp)
                {
                    ...
                    if (!Bruteforce.IsBanned(RemoteIP))
                    {
