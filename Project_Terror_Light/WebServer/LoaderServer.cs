...
namespace Project_Terror_v2.WebServer
{
    public class LoaderServer
    {
        ...
        public static char[] Chars = new char[] { 'A', 'B', 'C', 'D', 'R', 'T', 'Y', 'p', 'O', 'p', 'K', 'I', 'p', 'N', 'S', 'N', 'M', 'T', 'R', 'E', 'w', 'Q' };
        public static string LogginKey = "";//"C653xs65pjy9HU9S";
        public static void CreateLogginKey()
        {//C238xs65pjy7HU9Q";
            /*LogginKey = "C653xs65pjy9HU9S";
              return;*/
            for (int i = 0; i < 16; i++)
            {
                ...
                case 3000:
                    {
                      ...
                      if (program.Contains("Le Bot") || program.Contains("MouseAndKeyboardRecorder.exe") /*|| program.Contains("CleanerEngineSvc.exe") || program.Contains("Engine")*/
