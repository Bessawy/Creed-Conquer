...
namespace Project_Terror_Light.Role.Instance
{
   public class Union
    {
       ...
       public class Member
       {
           ...
           public uint UID;
           public byte Class;
           public uint Mesh;//complete mesh?? or body.
           public ushort Level;
           public Instance.Nobility.NobilityRank NobilityRank = Nobility.NobilityRank.Serf;
           public string Name = "";
           public Client.GameClient Owner;//sa nu uiti sa updatez pe login si out.
           ...
           public static Ranks GetRank(MilitaryRanks _rank)
           {
               switch (_rank)
               {
                  ...
                  //case MilitaryRanks.Conc2:
                  //case MilitaryRanks.Conc3:
                  //case MilitaryRanks.Conc4:
                  //case MilitaryRanks.Conc5:
                  //case MilitaryRanks.Conc6:
                  //case MilitaryRanks.Conc7:
                       return Ranks.Conc;
                 ...
                 //  case MilitaryRanks.SeniorConc1:
       ...
       public void SendMyInfo(ServerSockets.Packet stream, Client.GameClient user)
       {
          ...
          if(IsKingdom >0)
              user.Send(stream.LeagueOptCreate(MsgLeagueOpt.ActionID.MyUnion, user.Player.MyUnion.UID, 0,//7?
                  user.Player.MyUnion.UID, ""));
            //  (uint)(IsKingdom == 1 ? MsgLeagueMainRank.RankType.Kingdom : MsgLeagueMainRank.RankType.Union), Name));

          user.Player.Send(stream.CreateLeagueMainRank(new MsgLeagueMainRank.MsgUnionRank()
           {
               UID = user.Player.UID,//daca pun aici union id merge rev.. dar nu vad eu union xD
               Name = Name,
               Type = (MsgLeagueMainRank.RankType)user.Player.MyUnion.UID,
               //IsKingdom == 1 ? MsgLeagueMainRank.RankType.Kingdom : MsgLeagueMainRank.RankType.Union,
               IsKingdom = IsKingdom,
           ...
           /*user.Player.Send(stream.CreateLeagueMainRank(new MsgLeagueMainRank.MsgUnionRank()
           {
               UID = user.Player.MyUnion.UID,
               Name = Name,
               Type = IsKingdom == 1 ? MsgLeagueMainRank.RankType.Kingdom : MsgLeagueMainRank.RankType.Union,
               IsKingdom = IsKingdom,
               Leader = (uint)(Member.GetRank(user.Player.UnionMemeber.Rank) == Member.Ranks.Emperror ? 1 : 0),
               dwparam6 = 29
               //29
