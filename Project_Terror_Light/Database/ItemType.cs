...
namespace Project_Terror_Light.Database
{
    ...
    public class Rifinery : Dictionary<uint, Rifinery.Item>
    {
        ...
        public Rifinery()
        {
            ...
            MyConsole.WriteLine("Loading [" + baseText.Length + "] Refinery items");
            GC.Collect();
        }
...
360203
        ...
        public void Loading()
        {
            ...
            MyConsole.WriteLine("Loading [" + Count + "] items");
            itemsplus = null;
            GC.Collect();
        }
