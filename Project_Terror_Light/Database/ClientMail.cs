...
namespace Project_Terror_Light.Database
{
    public class ClientMail
    {
        public struct DBPrize
        {
            ...
            public DBPrize GetDBPrize(Project_Terror_Light.Game.MsgServer.PrizeInfo prize)
            {
                ID = prize.ID;
            ...
            public Project_Terror_Light.Game.MsgServer.PrizeInfo GetClientPrize()
            {
                Project_Terror_Light.Game.MsgServer.PrizeInfo Prize = new Game.MsgServer.PrizeInfo();
                Prize.ID = ID;
