...
namespace Project_Terror_Light.Database
{
    public class Server
    {
        ...
        public static DateTime RetailDuration;
        public static byte LordTokenCount = 5;
       ...
       public static uint ResetServerDay = 0;
        ...
        public static void Initialize()
        {
           ...
           // Program.ServerConfig.LoaderPort = IniFile.ReadUInt16("ServerInfo", "LoaderPort", 9901);
            ...
            RetailDuration = DateTime.FromBinary(IniFile.ReadInt64("RetailRedeem", "Duration", 0));
            ...
            Game.MsgTournaments.MsgSchedules.PkWar.WinnerMonthlyUID = IniFile.ReadUInt32("Tournaments", "MonthlyPkWarWinner", 0);
            ...
            RewardSystem.Load();
            PoPEdits.MapThreadsController.LoadController();
            FullLoading = true;
        }
        public static void SaveFestival()
        {
            WindowsAPI.IniFile write = new WindowsAPI.IniFile(System.IO.Directory.GetCurrentDirectory() + "\\shell.ini", true);
        ...
        public static void LoadMonsters()
        {
            try
            {
                ...
                LoadMapMonsters("Monsters10166.txt");
        ...
        public unsafe static void SaveDatabase()
        {
            ...
            try
            {
                ...
                IniFile.Write<uint>("Tournaments", "MonthlyPkWarWinner", Game.MsgTournaments.MsgSchedules.PkWar.WinnerMonthlyUID);
