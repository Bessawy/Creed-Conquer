...
namespace Project_Terror_Light.WindowsAPI
{
    public unsafe class IniFile
    {
        public string FileName;
        public IniFile(string _FileName, bool edited = false)
        {
            if (!edited)
            {
        ...
        public void Write<T>(string Section, string Key, T Value)
        {
            ...
            catch { MyConsole.WriteLine("Error In Section " + Section + " Field" + Key); }
        }
