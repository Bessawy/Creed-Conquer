...
namespace Project_Terror_Light
{
    public static class ThreadPoll
    {
        ...
        public static void Create()
        {
            ...
            GenericThreadPool = new StaticPool(11).Run();
            ReceivePool = new StaticPool(11).Run();
            SendPool = new StaticPool(11).Run();
            ...
            ConnectionReview = new TimerRule<ServerSockets.SecuritySocket>(_ConnectionReview, 2000);
        }
