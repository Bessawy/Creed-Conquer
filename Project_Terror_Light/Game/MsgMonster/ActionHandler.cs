...
namespace Project_Terror_Light.Game.MsgMonster
{
    public class ActionHandler
    {
        ...
        {
            if (monster.Family.ID == 23973 || monster.Family.ID == 22973 || monster.Family.ID == 23974 || monster.Family.ID == 3969)
                return false;
                    ...
                    else if (monster.Boss != 0)
                    {
                        ...
                        switch (monster.Family.ID)
                        {
                            ...
                            case 20070://snow bamshee
                                {
                                    List<ushort> Spells = new List<ushort>() { 10001, 30010, 30010, 30011, 30012, 30013, 30014, 30010, 10372 };
                                    ushort rand = (byte)Program.GetRandom.Next(0, Spells.Count);
                                    switch (Spells[rand])
                                    {
                                        case 10001:
