                    ...
                    case (ushort)Role.Flags.SpellID.Tranquility:
                        {
                           ...
                           , ClientSpell.Level, ClientSpell.UseSpellSoul);
                            ...
                            if (user.Player.UID == Attack.OpponentUID)
                            {
                                ...
                                user.Player.SendUpdate(stream, MsgUpdate.Flags.SoulShackle, 0, 0, 0, MsgUpdate.DataType.SoulShackle, false);
                            ...
                            else
                            {
                                ...
                                if (user.Player.View.TryGetValue(Attack.OpponentUID, out target, Role.MapObjectType.Player))
                                {
                                    ...
                                    attacked.SendUpdate(stream, MsgUpdate.Flags.SoulShackle, 0, 0, 0, MsgUpdate.DataType.SoulShackle, false);
