                    ...
                    case (ushort)Role.Flags.SpellID.ScatterFire:
                        {
                            ...
                            foreach (Role.IMapObj target in user.Player.View.AttackableRoles())
                            {
                                switch (target.ObjType)
                                {
                                    case Role.MapObjectType.Monster:
                                        {
                                            MsgMonster.MonsterRole attacked = target as MsgMonster.MonsterRole;
                                            if (SpellSector.Inside(attacked.X, attacked.Y))
                                            {
                                    ...
                                    case Role.MapObjectType.Player:
                                        {
                                    ...
                                    case Role.MapObjectType.SobNpc:
                                        {
