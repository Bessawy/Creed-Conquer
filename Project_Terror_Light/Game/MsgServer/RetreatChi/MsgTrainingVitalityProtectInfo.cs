...
namespace Project_Terror_Light.Game.MsgServer
{
    public static unsafe partial class MsgBuilder
    {
        ...
        public static unsafe ServerSockets.Packet AddRetreatedChiItem(this ServerSockets.Packet stream,Game.MsgServer.MsgChiInfo.ChiPowerType Type, Tuple<Project_Terror_Light.Role.Instance.Chi.ChiAttributeType, int>[] Gate, long Time)
        {
