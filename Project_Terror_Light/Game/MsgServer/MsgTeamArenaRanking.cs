...
namespace Project_Terror_Light.Game.MsgServer
{
    public unsafe static partial class MsgBuilder
    {
        ...
        public static unsafe ServerSockets.Packet AddItemTeamArenaRanking(this ServerSockets.Packet stream, uint Rank, uint History
            ...
            try
            {
                ...
                for (int x = 0; x < count; x++)
                {
                    if (info.Length > offset + x)
                    {
                        ...
                        {
                            stream.AddItemTeamArenaRanking((ushort)(offset + x + 1),  element.Info.HistoryHonor, element.Info.ArenaPoints
