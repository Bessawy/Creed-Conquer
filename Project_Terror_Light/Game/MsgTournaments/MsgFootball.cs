...
#else
                MsgSchedules.SendInvitation("Football[SS/FB]", "ConquerPoints, 1-PowerExpBalls", 300, 277, 1002, 0, 60);
#endif
...
#else
                        user.CreateBoxDialog("Your team won and received 5000 ConquerPoints.");
#endif
...
#else
                        user.CreateBoxDialog("Your team lose : ( .Better luck next time. You received 2000 CPs.");
#endif
