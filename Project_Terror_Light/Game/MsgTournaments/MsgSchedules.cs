...
namespace Project_Terror_Light.Game.MsgTournaments
{
    public class MsgSchedules
    {
        ...
        internal static NobilityCrossWar CrossNobility;
        ...
        internal static MsgGiantChasm GiantChasm;
        internal static MsgCpsArenaSingle ArenaCpsBattle;
        ...
        internal static void Create()
        {
            ...
            CrossNobility = new NobilityCrossWar(TournamentType.CrossNobilityWar);
            ...
            GiantChasm = new MsgGiantChasm(ProcesType.Dead);
            ArenaCpsBattle = new MsgCpsArenaSingle(ProcesType.Dead);
            ...
            QuizShow = new MsgQuizShow(TournamentType.QuizShow);
        ...
        internal static void CheckUp(Extensions.Time32 clock)
        {
            ...
            if (clock > Stamp)
            {
                ...
                if (GiantChasm.Process == ProcesType.Dead)
                {
                    GiantChasm.Process = ProcesType.Idle;
                }
                try
                {
                    ArenaCpsBattle.CheckUp();
                    SteedRace.work(0);
                    DragonIsland.CheckUp();
                    GiantChasm.CheckUp();
                    PowerArena.CheckUp();
                    ...
                    if (Now64.Hour == 18 && Now64.Minute == 55 && Now64.DayOfWeek == DayOfWeek.Saturday)
                    ...
                    {
                        if (Now64.Hour == 8 && (Now64.Minute >= 0 && Now64.Minute <= 19))
                        {
                            if (PkWar.Started() == false)
                            {
                                PkWar.Open();
                            }
                        }
