...
namespace Project_Terror_Light.Game.MsgTournaments
{
    ...
    {
       public const uint RewardConquerPoints = 5000;
...
#else
               MsgSchedules.SendInvitation("ExtremePk", "ConquerPoints", 300, 277, 1002, 0, 60);
#endif
  ...
  MsgSchedules.SendSysMesage("" + Winner.Player.Name + " has Won  ExtremePk. ", MsgServer.MsgMessage.ChatMode.BroadcastMessage, MsgServer.MsgMessage.MsgColor.white);
       ...
       public void SharePoints(Client.GameClient user, Client.GameClient Killer)
       {
         ...
         //  uint Receiveextremepoints = (uint)(xtremepoints + Program.GetRandom.Next(1, 25));
