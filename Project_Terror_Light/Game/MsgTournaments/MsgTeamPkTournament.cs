    ...
    public class MsgSkillTeamPkTournament
    {
        ...
        public void Start()
        {
            if (Proces == ProcesType.Dead)
            {
                ...
                {
                    client.Player.MessageBox("The Skill Team PK Tournament will start at 20:00. Prepare yourself and sign up for it as a team!", new Action<Client.GameClient>(p => p.Teleport(317, 142, 1002, 0)), null, 60, MsgServer.MsgStaticMessage.Messages.None);
                }
            }
        }
        public void Save()
            ...
            foreach (var tournament in EliteGroups)
            {
                ...
                if (tournament.GetReward(client, out Rank))
                {
                    ...
                    if (Rank == 1)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank "+Rank+" on Skill Team Tournament and claimed 15,000 Conquer Points & 1 " + DBItem.Name + ".";
                    ...
                    else if (Rank == 2)
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank "+Rank+" on Skill Team Tournament and claimed 10,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 10,000 Conquer Points & 1 " + DBItem.Name + ".";
                    ...
                    else if (Rank == 3)
                    {
                        client.Player.ConquerPoints += 8000;
                           ...
                           client.CreateBoxDialog("You've received a " + DBItem.Name + " and 8000 ConquerPoints.");
                                  string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank "+Rank+" on Skill Team Tournament and claimed 8,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 8000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 8,000 Conquer Points & 1 " + DBItem.Name + ".";
                    ...
                    else
                    {
                        ...
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank "+Rank+" on Skill Team Tournament and claimed 5,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 5000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Skill Team Tournament and claimed 5,000 Conquer Points & 1 " + DBItem.Name + ".";
    ...
    public class MsgTeamPkTournament
    {
        ...
        public void Start()
        {
            if (Proces == ProcesType.Dead)
            {
                ...
                foreach (var client in Database.Server.GamePoll.Values)
                {
                    client.Player.MessageBox("", new Action<Client.GameClient>(p => p.Teleport(292, 146, 1002, 0)), null, 60, MsgServer.MsgStaticMessage.Messages.TeamPkTournament);
                }
            }
        }
        public void Save()
...
#if Arabic
                            client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank "+Rank+" on Team Pk Tournament and claimed 10,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 10000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Team Pk Tournament and claimed 10,000 Conquer Points & 1 " + DBItem.Name + ".";
    ...
    public class MsgTeamEliteGroup
    {
        ...
        public class Match
        {
            ...
            public uint TimeLeft
            {
                get
                {
                    int val = (int)((ImportTime.AddSeconds(60 * 10).AllMilliseconds - Extensions.Time32.Now.AllMilliseconds) / 1000);
                    if (val < 0) val = 0;
                    return (uint)val;
                }
            }
        ...
        public void timerCallback(Extensions.Time32 clock)//need to add a void to remove from teams
        {
            try
            {
                if (clock > TimerStamp)
