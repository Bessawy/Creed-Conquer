    ...
    public class MsgTreasureThief : ITournament
    {
...
#else
                MsgSchedules.SendInvitation("TreasureThief", "ConquerPoints,Money,Vip and others treasures", 300, 277, 1002, 0, 60);
#endif
        ...
        public void Reward(Client.GameClient user,Game.MsgNpc.Npc npc, ServerSockets.Packet stream)
        {
            ...
            switch (rand)
            {
                case 0://money
                    {
                        uint value = (uint)Program.GetRandom.Next(1000000, 15000000);
                ...
                case 2://cps
                    {
                        uint value = (uint)Program.GetRandom.Next(100, 500);
