...
namespace Project_Terror_Light.Game.MsgTournaments
{
    public class MsgEliteTournament
    {
        ...
        public void Start()
        {
            if (Proces == ProcesType.Dead)
            {
                ...
                else
                {
                    ...
                    {
                        client.Player.MessageBox("", new Action<Client.GameClient>(p => p.Teleport(302, 151, 1002, 0)), null, 60, MsgServer.MsgStaticMessage.Messages.ElitePKTournament);
                    }
                }
            }
        }
        ...
        public bool SignUp(Client.GameClient client)
        {
            ...
            {
                client.SendSysMesage("Need to be level 100 at least.");
                return false;
            }
        ...
        public bool GetReward(Client.GameClient client, ServerSockets.Packet stream)
        {
            foreach (var tournament in EliteGroups)
            {
                ...
                {
                    if (tournament.GroupTyp == GroupTyp.EPK_Lvl130Plus && Rank == 1)
                    {
                        client.Player.AddSpecialTitle(MsgTitleStorage.TitleType.WingsofInfernal, stream);
                    }
...
#if Arabic
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " , 10,000 ConquerPoints and a wing (WingsofInfernal).");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 10,000 Conquer Points & 1 " + DBItem.Name + ".";
...
#if Arabic
                         client.CreateBoxDialog("You've received a " + DBItem.Name + " and 8,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 8,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 8,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 8,000 Conquer Points & 1 " + DBItem.Name + ".";
                    ...
                    {
                        client.Player.ConquerPoints += 6000;
#if Arabic
                                                 client.CreateBoxDialog("You've received a " + DBItem.Name + " and 6,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 6,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 6,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 6,000 Conquer Points & 1 " + DBItem.Name + ".";
...
#if Arabic
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 4,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 4,000 Conquer Points & 1 " + DBItem.Name + ".";
                        Program.SendGlobalPackets.Enqueue(new MsgMessage(MSG, MsgMessage.MsgColor.red, MsgMessage.ChatMode.System).GetArray(stream));
#else
                        client.CreateBoxDialog("You've received a " + DBItem.Name + " and 4,000 ConquerPoints.");
                        string MSG = "Congratulation to " + client.Player.Name + " ! he/she managed to get rank " + Rank + " on Elite PK Tournament and claimed 4,000 Conquer Points & 1 " + DBItem.Name + ".";
    ...
    public class MsgEliteGroup
    {
        ...
        public class Match
        {
            ...
            public uint TimeLeft
            {
                get
                {
                    int val = (int)((ImportTime.AddSeconds(60 * 7).AllMilliseconds - Extensions.Time32.Now.AllMilliseconds) / 1000);
                    if (val < 0) val = 0;
                    return (uint)val;
                }
            }
