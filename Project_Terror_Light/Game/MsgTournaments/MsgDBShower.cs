    ...
    public class MsgDBShower : ITournament
    {
        ...
        public void Open()
        {
            if (Process == ProcesType.Dead)
            {
                ...
                MsgSchedules.SendInvitation(Name, Prize, 300, 277, 1002, 0, 60);
#endif
        ...
        {
            Project_Terror_Light.Game.MsgServer.ActionQuery action = new Project_Terror_Light.Game.MsgServer.ActionQuery()
            {
                ObjId = user.Player.UID,
                Type = Project_Terror_Light.Game.MsgServer.ActionType.SetMapColor,
                dwParam = 16755370,
