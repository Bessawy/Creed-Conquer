                ...
                using (var rec = new ServerSockets.RecycledPacket())
                {
                    ...
                    if (DateTime.Now.Hour != Database.Server.ChasmBloodyBansheeHour.Hour && DateTime.Now.Minute == 10)
                    {
                        if (!Map.ContainMobID(29370))//Bloody Banshee
                        {
                            ...
                            Database.Server.AddMapMonster(stream, Map, 29370, 238, 165, 3, 3, 1, 0, true, Project_Terror_Light.Game.MsgFloorItem.MsgItemPacket.EffectMonsters.None);
                    ...
                    if (DateTime.Now.Hour != Database.Server.ChasmChillingSpookHour.Hour && DateTime.Now.Minute == 20)
                    {
                        if (!Map.ContainMobID(29360))//Chilling Spook
                        {
                            ...
                            Database.Server.AddMapMonster(stream, Map, 29360, 214, 96, 3, 3, 1, 0, true, Project_Terror_Light.Game.MsgFloorItem.MsgItemPacket.EffectMonsters.None);
                    ...
                    if (DateTime.Now.Hour != Database.Server.ChasmNetherTyrantHour.Hour && DateTime.Now.Minute == 40)
                    {
                        if (!Map.ContainMobID(29300))//Nether Tyrant
                        {
                            ...
                            Database.Server.AddMapMonster(stream, Map, 29300, 257, 136, 3, 3, 1, 0, true, Project_Terror_Light.Game.MsgFloorItem.MsgItemPacket.EffectMonsters.None);
                    ...
                    if (DateTime.Now.Hour != Database.Server.ChasmDragonWraithHour.Hour && DateTime.Now.Minute == 50)
                    {
                        if (!Map.ContainMobID(29363))//Dragon Wraith
                        {
                            ...
                            Database.Server.AddMapMonster(stream, Map, 29363, 204, 138, 3, 3, 1, 0, true, Project_Terror_Light.Game.MsgFloorItem.MsgItemPacket.EffectMonsters.None);
