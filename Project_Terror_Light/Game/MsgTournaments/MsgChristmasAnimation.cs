...
namespace Project_Terror_Light.Game.MsgTournaments
{
    public class MsgChristmasAnimation
    {
        public class Reindeer
        {
            ...
            public bool IsMidle()
            {
                return Project_Terror_Light.Role.Core.GetDistance(StartX, StartY, MoveToX, MoveToY) / 2 == StartX - Role.X; 
            }
            public void DropItem(ushort x, ushort y, ServerSockets.Packet stream)
            {
                ...
                DataItem.Color = Project_Terror_Light.Role.Flags.Color.Red;
