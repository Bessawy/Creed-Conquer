...
check why desconnecting in pk exploit list packet send to client = done
Create invoker for items time check = done
check merchant system to complete it = done
check claim cp button to complete it = done
check and other system needed to be added
check item agate system try to use it = done
update packet coatstorage remove old one and add new one item (time | bound | extra effects) = done
fiend's lair
moonbox quest = done
weeklymarketquest
skilleriaser
complete activiness { daily quest, horse racing, etc}
