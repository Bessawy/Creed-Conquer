...
18????*/
       ...
       // public Extensions.Exchangelocks Exchange = new Extensions.Exchangelocks();
        ...
        //-----------------------------
        public Dictionary<Project_Terror_Light.Game.MsgServer.Reward.Mode, Project_Terror_Light.Database.ClientRewards.Rewards> Rewards;
        ...
        public void IncreaseExperience(ServerSockets.Packet stream, double Experience, Role.Flags.ExperienceEffect effect = Role.Flags.ExperienceEffect.None)
        {
            ...
            if (Player.Level < 140)
            {
             ...
             //   if (Player.Level < 130)
                ...
                {
                    Project_Terror_Light.Database.ActionHelper.LvlAction.Invoke(stream, this);
                }
#else
        ...
        public GameClient(ServerSockets.SecuritySocket _socket, bool _OnInterServer = false)
        {
            ...
            Rewards = new Dictionary<Game.MsgServer.Reward.Mode, Database.ClientRewards.Rewards>();
            ArenaStatistic = new Game.MsgTournaments.MsgArena.User();
            MailBox = new System.Collections.Concurrent.ConcurrentDictionary<uint, PrizeInfo>();
        ...
        public void AddMailPrize(ServerSockets.Packet stream, string Sender = "LightConquer", string Subject = "Reward", string Message = "Congratulations, you have been rewarded.", ulong Silver = 0, ulong Beans = 0, uint Cps = 0, uint Attachment = 0, MsgGameItem Item = null)
        {
